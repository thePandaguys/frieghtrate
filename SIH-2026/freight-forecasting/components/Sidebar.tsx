...
const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { label: 'Routes',            icon: 'map',          set: 'F', route: '/(main)/routes' },
    ],
  },
  {
    label: 'Optimizers',
    items: [
      { label: 'Vessel Optimizer',   icon: 'ship-wheel',  set: 'M', route: '/(main)/vessels' },
      { label: 'Cargo Optimizer',    icon: 'package',     set: 'F', route: '/(main)/optimizer' },
      { label: 'Contract Optimizer', icon: 'file-text',   set: 'F', route: '/(main)/reports' },
      { label: 'Cost Optimizer',     icon: 'dollar-sign', set: 'F', route: '/(main)/stats' },
    ],
  },
  {
    label: 'Operations',
    items: [
      { label: 'Reports',    icon: 'bar-chart-2', set: 'F', route: '/(main)/reports' },
      { label: 'Statistics', icon: 'bar-chart',   set: 'F', route: '/(main)/stats' },
      { label: 'Simulator',  icon: 'cpu',         set: 'F', route: '/(main)/simulator' },
      { label: 'Alerts',     icon: 'bell',        set: 'F', route: '/(main)/alerts' },
      { label: 'Policy',     icon: 'shield',      set: 'F', route: '/(main)/policy' },
      { label: 'Waste',      icon: 'trash-2',     set: 'F', route: '/(main)/waste' },
    ],
  },
  {
    label: 'Account',
